import { LitElement, html, css, classMap, unsafeCSS, map } from 'https://cdn.jsdelivr.net/gh/lit/dist@2.6.1/all/lit-all.min.js';
const cssLiteral = window.masterCSSLiteral;
const cls = {
  unit: {
    '': cssLiteral.$`
      rel h:full r:4 fg:theme-fg bg:theme shadow:2|2|8|0|theme/.16 overflow:hidden
