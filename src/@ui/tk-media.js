import { LitElement, html, css, classMap, unsafeCSS, nothing, ref, createRef, literal, staticHtml } from 'https://cdn.jsdelivr.net/gh/lit/dist@2.6.1/all/lit-all.min.js';
